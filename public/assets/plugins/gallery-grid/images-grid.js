...
$('#gallery').imagesGrid({
  ...
  on<a href="http://www.jqueryscript.net/tags.php?/Modal/">Modal</a>Open: $.noop,
  onModalClose: $.noop,
  onModalImageClick: $.noop,
  onModalImageUp<a href="http://www.jqueryscript.net/time-clock/">date</a>: $.noop
...
;(function($) {
    ...
    $.fn.imagesGrid.defaults = {
        ...
        loading: '<div class="images-loading"></div>',
    ...
    ImagesGrid.prototype.align = function() {
        ...
        switch (itemsLen) {
            ...
            case 3:
                ...
                break;
            case 4:
                this.alignItems(this.$gridItems.slice(0, 1));
                this.alignItems(this.$gridItems.slice(1));
