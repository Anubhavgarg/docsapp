...
'<div class="topbar-left">'+
    '<a href="index.html" class="logo">'+
        '<i class="icon-c-logo">'+
            '<img id="logo" src="../Uplon-v1.4/assets/images/samplelogo.png" width="200px" height="90px">'+
            '<img id="logo1" src="../Uplon-v1.4/assets/images/samplelogo1.png" width="36px" height="36px">'+
        '</img></i>'+
        '<span></span></a>'+
'</div>';
...
'            <li class="has_sub">'+
'               <div>'+
'                    <a href="javascript:void(0);" class="waves-effect menu-title">'+
'                        <div id="user-title" class="user-title">'+
'                            <img src="../Uplon-v1.4/assets/images/users/avatar-1.jpg" alt="user" class="img-circle">'+
'                        </div>'+
'                        <div id="user-desc" class="user-title-desc">'+
'                            <span class="content-md text-capitalize"> Someone New </span>'+
'                            <span class="menu-arrow pull-right" style="margin-top:15px"></span>'+
'                            <span class="content-sm text-capitalize"><br /> Some Position </span>'+
'                        </div>'+
'                    </a>'+
...
'            </li>'+
'            <li class="has_sub">'+
'                <a href="javascript:void(0);" class="waves-effect"><i class="zmdi zmdi-collection-text"></i><span> Forms </span> </a>'+
'                <ul class="list-unstyled">'+
...
'</div>'+
'<div id="menu-footer" class="menu-footer text-uppercase">2016 © Powered by NextGen</div>';